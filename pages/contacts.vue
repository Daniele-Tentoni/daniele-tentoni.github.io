        ...
        >
            <div class="block">
                <div class="block mb-8">
                    <span class="">{{ $t("contacts.block.description") }}</span>
                </div>
                    ...
                    <nav class="level">
                        ...
                        <div class="level-item has-text-centered">
                            <div>
                                ...
                                <p class="title">
                                    <a
                                        href="https://github.com/daniele-tentoni"
                                        target="_blank"
                                    >
                                        Daniele-Tentoni
                                    </a>
        ...
        >
            <div class="container">
                <MyInput :label="$t('contacts.textme.name.label')">
                    <div class="control">
                        <input
                            ...
                            type="text"
                            :placeholder="
                                $t('contacts.textme.name.placeholder')
                            "
                        />
                    </div>
                </MyInput>
                ...
                >
                    <div class="control has-icons-left has-icons-right">
                        <input
                            ...
                            type="email"
                            :placeholder="
                                $t('contacts.textme.from.placeholder')
                            "
                        />
                ...
                <MyInput :validation-rule="() => message !== ''">
                    <template #label>
                        <MyLabel>{{
                            $t("contacts.textme.message.label")
                        }}</MyLabel>
                    </template>
                    <div class="control">
                        <textarea
                            ...
                            class="textarea"
                            :placeholder="
                                $t('contacts.textme.message.placeholder')
                            "
                        />
                    </div>
                    <template #errorMessage>
